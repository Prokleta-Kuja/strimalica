...
<template>
  <div className="container-fluid mt-2">
    <div className="list-group list-group-flush">
      ...
      <button type="button" @click="radio.toggleRadio" class="text-center list-group-item list-group-item-action"
        :class="[radio.isPlaying ? 'list-group-item-danger' : 'list-group-item-primary']">
    ...
    <div className="d-flex justify-content-between">
      <div className="mt-4">
        <button className="btn btn-outline-primary" @click="refresh">
          ...
          </svg><i className="bi bi-arrow-clockwise"></i>
        </button>
      </div>
      ...
      <div className="mt-4">
        <button className="btn btn-outline-success" @click="radio.changeDevice">
